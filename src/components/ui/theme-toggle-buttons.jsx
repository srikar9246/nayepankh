...
const Options = ({
  ...
  return (
    <motion.div
      className="theme-options-panel flex flex-col gap-3 border p-3 backdrop-blur-sm"
      drag={isDragging}
      dragMomentum={false}
    >
...
export const ThemeToggleButton1 = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "rounded-full bg-black text-white transition-all duration-300 active:scale-95 flex items-center justify-center",
        className,
      )}
      onClick={toggleTheme}
    >
